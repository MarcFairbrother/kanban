...
describe('EditCard.vue', () => {
  ...
  const handleEditCardData = jest.fn();
  ...
  it('calls handleEditCardData on blur', () => {
    wrapper.find('h2').trigger('blur');
    wrapper.find('p').trigger('blur');
    expect(handleEditCardData).toHaveBeenCalledTimes(2);
  });
});
